...
let g:colors_name="soft-lettuce"
...
hi Normal           cterm=none       ctermbg=235 ctermfg=189
hi StatusLine       cterm=none       ctermbg=233 ctermfg=103
hi StatusLineNC     cterm=none       ctermbg=234 ctermfg=103
hi User1            cterm=bold       ctermbg=235 ctermfg=223
hi User2            cterm=none       ctermbg=235 ctermfg=240
hi VertSplit        cterm=none       ctermbg=235 ctermfg=103
hi TabLine          cterm=none       ctermbg=235 ctermfg=145
hi TabLineFill      cterm=none       ctermbg=235
hi TabLineSel       cterm=none       ctermbg=240 ctermfg=253
hi LineNr           cterm=none                   ctermfg=238
hi NonText          cterm=bold       ctermbg=235 ctermfg=241
hi Folded           cterm=none       ctermbg=234 ctermfg=136
hi FoldColumn       cterm=none       ctermbg=235 ctermfg=103
hi SignColumn       cterm=none       ctermbg=235 ctermfg=103
hi CursorColumn     cterm=none       ctermbg=234
hi CursorLine       cterm=none       ctermbg=234
hi IncSearch        cterm=bold       ctermbg=63  ctermfg=235
hi Search           cterm=none       ctermbg=36  ctermfg=235
hi Visual           cterm=none       ctermbg=24
hi WildMenu         cterm=bold       ctermbg=35  ctermfg=235
...
hi Constant         cterm=none                   ctermfg=133
 "hi String          cterm=none       ctermbg=235 ctermfg=215
 hi String          cterm=none                   ctermfg=217
 "hi Character       cterm=none       ctermbg=235 ctermfg=215
 hi Character       cterm=none                   ctermfg=193
 hi Number          cterm=none                   ctermfg=85
 hi Float           cterm=none                   ctermfg=85
hi Identifier       cterm=none                   ctermfg=186
 hi Function        cterm=none                   ctermfg=210
hi Statement        cterm=bold                   ctermfg=69
 hi Exception       cterm=bold                   ctermfg=97
 hi Operator        cterm=none                   ctermfg=75
 hi Label           cterm=none                   ctermfg=69
...
" highlight modes
autocmd InsertEnter * hi StatusLine ctermbg=235
autocmd InsertEnter * hi User1      ctermbg=235
autocmd InsertEnter * hi User2      ctermbg=235
autocmd InsertLeave * hi User2      ctermbg=235
autocmd InsertLeave * hi User1      ctermbg=235
autocmd InsertLeave * hi StatusLine ctermbg=235
...
autocmd CmdwinLeave * hi User2      ctermbg=235
autocmd CmdwinLeave * hi User1      ctermbg=235
autocmd CmdwinLeave * hi StatusLine ctermbg=233
