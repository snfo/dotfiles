...
highlight search       ctermbg=lightgreen   cterm=bold
...
" Colors for AutoComplPop popup box
highlight Pmenu        ctermbg=blue         ctermfg=black cterm=bold
highlight PmenuSel     ctermbg=lightblue    ctermfg=black cterm=bold
